...
PlaySurface = pygame.display.set_mode((800, 750))
...
pSurf = pfont.render('Welcome to Snake Game created by Surya.', True, blue) # add your name here
...
def gameOver():
    ...
    GOsurf = gFont.render('Game over hahahaha!', True, red)
...
#powered by SVGsuryaTN groups
#free to use
#make By Surya
#k.kovil
#if it does not work plz install pygame in comiler terminal
#pip install pygame
#it is used to install pygame in your pc
#READ ME option is there
#powered by SVGsuryaTN groups
